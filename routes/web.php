...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/pay/{order}', [DashboardController::class, 'show'])->name('pay.show');
...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::redirect('/user/address', '/admin/user/addresses');
    ...
    Route::controller(\App\Http\Controllers\Admin\UserController::class)->group(function () {
        ...
        Route::get('user/addresses', 'addresses')->name('admin.user.addresses');
        Route::patch('user/{user}/role', 'updateRole')->name('admin.user.role');
    ...
    Route::controller(\App\Http\Controllers\Admin\PaymentController::class)->group(function () {
        Route::get('payment/index', 'index')->name('admin.payment.index');
    });

    //store settings
    Route::controller(\App\Http\Controllers\Admin\StoreSettingController::class)->group(function () {
        Route::get('setting/index', 'index')->name('admin.setting.index');
        Route::post('setting/update', 'update')->name('admin.setting.update');
    });
    ...
    Route::controller(\App\Http\Controllers\Admin\ProfileController::class)->group(function () {
        ...
        Route::patch('profile/update', 'update')->name('admin.profile.update');
